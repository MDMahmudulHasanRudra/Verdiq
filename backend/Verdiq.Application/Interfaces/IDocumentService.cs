...
public interface IDocumentService
{
    ...
    Task<(Stream? FileStream, string? ContentType, string? FileName)> PreviewAsync(Guid id);
    Task<IEnumerable<DocumentResponseDto>> GetAllAsync(Guid chamberId, string? category = null, int page = 1, int pageSize = 10, Guid? caseId = null, string? search = null);
