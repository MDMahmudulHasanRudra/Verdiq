...
namespace Verdiq.Infrastructure.Migrations
{
    ...
    [Migration("20260804071151_AddBailTypeAndNextHearingDate")]
    partial class AddBailTypeAndNextHearingDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Verdiq.Domain.Entities.CasePhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verdiq.Domain.Entities.CaseWorkflow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CaseWorkflows", (string)null);
                });

            modelBuilder.Entity("Verdiq.Domain.Entities.CaseWorkflowStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CaseWorkflowSteps", (string)null);
                });
            ...
            modelBuilder.Entity("Verdiq.Domain.Entities.Judgment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verdiq.Domain.Entities.Workflow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verdiq.Domain.Entities.WorkflowStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verdiq.Domain.Entities.CaseWorkflow", b =>
                {
                    b.HasOne("Verdiq.Domain.Entities.Case", "Case")
                        .WithMany("CaseWorkflows")
                        .HasForeignKey("CaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Verdiq.Domain.Entities.User", "StartedBy")
                        .WithMany()
                        .HasForeignKey("StartedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Verdiq.Domain.Entities.Workflow", "Workflow")
                        .WithMany("CaseWorkflows")
            ...
            modelBuilder.Entity("Verdiq.Domain.Entities.CaseWorkflowStep", b =>
                {
                    b.HasOne("Verdiq.Domain.Entities.CaseWorkflow", "CaseWorkflow")
                        .WithMany("Steps")
                        .HasForeignKey("CaseWorkflowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Verdiq.Domain.Entities.User", "CompletedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Verdiq.Domain.Entities.Judgment", b =>
                {
                    ...
                    b.HasOne("Verdiq.Domain.Entities.User", "RecordedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Verdiq.Domain.Entities.Task", b =>
                {
                    ...
                    b.HasOne("Verdiq.Domain.Entities.Hearing", "Hearing")
                        .WithMany("Tasks")
